package com.hieulv.videocallpc.view;

import com.google.gson.Gson;
import com.hieulv.videocallpc.model.*;
import com.hieulv.videocallpc.network.SocketManager;
import com.hieulv.videocallpc.network.VideoCallCommand;
import com.hieulv.videocallpc.utils.Constants;
import com.hieulv.videocallpc.view.call.VideoCallPanel;
import com.hieulv.videocallpc.view.callrequest.CallRequestPanel;
import com.hieulv.videocallpc.view.friend.FriendPanel;
import com.hieulv.videocallpc.view.home.HomePanel;
...
public class HomeUI extends JFrame implements HomePanel.HomePanelDelegate,
        SocketManager.SocketManagerDelegate, FriendPanel.FriendPanelDelegate,
        CallRequestPanel.CallRequestPanelDelegate, VideoCallPanel.VideoCallPenalDelegate {
    ...
    public void callFriend(ArrayList<RqUserInfo.UserInfo> friends) {
        ...
        videoCallPanel.setListener(this);
    ...
    public void onClickEndCall() {
        panels.remove(videoCallPanel);
        remove(videoCallPanel);
        videoCallPanel = null;
        add(homePanel);
        validate();
    }
