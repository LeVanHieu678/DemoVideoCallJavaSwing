...
public class Constants {
    //network
    public static String SIGNALING_SERVER = "192.168.1.102";//"34.87.150.46";//"192.168.25.108";
    public  static String TURN_SERVER = "192.168.1.102";//"34.87.150.46";//"192.168.25.108";
    //
