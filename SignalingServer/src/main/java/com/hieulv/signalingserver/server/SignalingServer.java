...
import com.hieulv.signalingserver.model.*;
import com.hieulv.signalingserver.utils.CommandManager;
    ...
    public void clientSendCommand(UserModel user, String message) {
        ...
        switch (req.getSignalKey()) {
            ...
            case "CALL_RESPONSE":
                ...
                for (UserModel member: user.getRoom().getMembers()) {
                    member.sendCommand(message);
                }
